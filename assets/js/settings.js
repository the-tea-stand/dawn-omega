...
const description =
  "<span>We serve free tea to cultivate trust<br/>& connection around Brooklyn.<br/><br/>To date, we've served<br/>13,208 cups of free tea!</span>";
...
<div>
Our members make this all this possible — together, we are cultivating neighborhood trust, building local autonomy, and serving FREE TEA FOR ALL!
</div>
<div>
...
let membershipTiers = [
  ...
  },
  {
    ...
    perks: [
      ...
      {
        state: "bold",
        title: "🛒 Discounted Merch (20%)",
        subtitle:
          "Receive 20% off on all items on our online merch store. Plus free shipping!",
      },
      {
        state: "bold",
