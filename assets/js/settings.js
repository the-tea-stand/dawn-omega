...
const description =
  "<span>We serve free tea to cultivate trust<br/>& connection around Brooklyn.<br/><br/>To date, we've served<br/>14,124 cups of free tea!</span>";
...
const getInvolvedSections = [
   ...
   },
   {
     title: "Volunteer",
     description:
       "Serve tea at an event, illustrate a flyer, and/or help prep tea.",
     ctaText: "Learn More",
     url: "/volunteer",
   },
   {
    ...
    perks: [
      {
        ...
        subtitle:
          "Every issue of our riso-printed, collaborative zine delivered to your door. 16+ pages. Published on solstices + equinoxes (4x/year).",
      },
      {
        state: "bold",
        title: "🌿 Seasonal Teas + Storage Tins",
        subtitle: "Receive 3 tea bags of unique, curated teas with every zine delivery (4x/year). You'll also receive a set of 3 custom, stackable tins for your teas!",
      },
      {
        state: "bold",
        title: "🍵 Custom Mug",
  ...
  },
  {
    ...
    perks: [
      ...
      },
      {
        ...
        subtitle:
          "Linen tea towel with custom hand-embroidery. Available in purple and green, your choice!",
      },
      {
        state: "bold",
    ...
    perks: [
      {
        ...
        subtitle:
          "An artisanal \"easy gaiwan\" teapot made by local ceramicist Lilian Wu (example pictured above). Each teapot is one-of-a-kind!",
      },
      {
        state: "bold",
...
<div>
Moustafa Abdelaziz, Sam Aberbuch, Robin Achtstetter, Shamile Aldossary, Hannah Alexander, Eric Alvarez, Jade Ammeen, Arlene Arevalo, Maria Paula Arriaga, Arlou Arteta, Ben Averbuch, Arnie, Jess Balgobin, Tim Bannister, Vasilisa Bashlovkina, Ziggy Bee, Alex Bender, Amory Benjamin, Nat Berman, Micah Bernat, Tanya Bhatia, Mat Bibik, Casey Bivens, Veronica Blackwell, Alexander Blaha, Josie Bradshaw, Autumn Brown, Tip Bulante, Peter Camardo, Jennifer Calandra, Carmen, Timothy Chacko, Tami Chaize, Kristen Chen, Jac Clayton, Clare Cullinan, Sabar Dasgupta, Steven DeGroot, Josh DeSieno, Kaitlin Deveau, Nick Deveau, Clay Devlin, Allyssa Dezaldivar, Lynn Dreifus, Mack Drummond, Tony Edelstein, Lauren Espinola, Hugh Ferguson, Aery Foist, Zoe Fortune, Andrea Garcia, Eli Goldman, Kendall Greene, Elizabeth Gruber, Emma Gubitz, Leighanne Guettler, Emma Hancock, Caroline Hanlon, Dewi Harjanto, Nadine Hemming, Liz Hendy, Sebastian Hodge, Mokarram Hossain, Riba Hossain, Anne Hubben, Wilson Jacobs, JW, Aidan Kaminer, Lavina Khan, Divisha Khandelwal, Izzie Kirsch, Kenny Kirsch, Nicki Klar, Paige Kloss, Daniela Kotovsky, Ariel Kovlakas, Devika Kumar, Emily LaBombard, Serena Lakhiani, Darren Lee, Tori Lee, Serena Lewin, Anna Lin, Sophia Livecchi, Taylor Maude Love, Anqi Lu, John Martin, Nikki Martinez, Charlotte McCune, Mark McGovern, Joy Minkoff, Nickon Mir, Mateo Mok, Anien Monsoon, Jim Moore, Jesse Morgan, Naqiya Motiwalla, Taher Motiwalla, David Myers, Max Nadelman, Mae Nagusky, Kelly Nagusky, Stephen New, Isa Nicdao, Michelle Nip, Ray Orr, Matti Parone, Zachary Paul, Grayson Pike, Addy Pedro, Noel Peng, Amira R, Momo Ramstedt, Kate Revels, Elliot Richardson, Ella Richmond, Aidan Ryan, Noah Sai, Natalie Sears, Jada Shannon, Juniper Sokolov, Yelena Sokolov, Juliet Shen, Kathryn Stadt, Peter Steele, Janice Steele, Julia Strout, Elton Sun, Aimee Tadmore, Nick Tobier, Charmaine Thomas, Tanner Tomasi, Jean Paul Torre, Finn Trondson, Rebecca Urena, Adin Vashi, Lucas Vickers, Thinh Vu, Hannah Weisz, Edmund White, Val Yang, Joellene Yap, Josh You, Zack Young, Jen Zafra, Sarah Zigler
</div>
<div>
<b><a href='/a-note-from-miles' class='link'>You can find my privilege statement here.</a></b>
</div>
`;
