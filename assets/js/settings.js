...
const description =
  "<span>We serve free tea to build trust<br/>and community around Brooklyn.<br/><br/>To date, we've served 7,776<br/>free cups and counting!</span>";
...
<a href='/a-note-from-miles' class='link'>my</a> full-time work and is sustained by neighbors & comrades like you :)
</div>
<div>
...
<div>
For more details about the perks, <a href='/member-perks' class='link'>click here</a>.
</div>
<div>
...
<div>
Moustafa Abdelaziz, Sam Aberbuch, Robin Achtstetter, Shamile Aldossary, Eric Alvarez, Jade Ammeen, Maria Paula Arriaga, Arlou Arteta, Ben Averbuch, Tim Bannister, Ziggy Bee, Alex Bender, Nat Berman, Micah Bernat, Tanya Bhatia, Mat Bibik, Casey Bivens, Veronica Blackwell, Josie Bradshaw, Autumn Brown, Peter Camardo, Jennifer Calandra, Carmen, Tami Chaize, Kristen Chen, Jac Clayton, Clare Cullinan, Sabar Dasgupta, Kaitlin Deveau, Nick Deveau, Clay Devlin, Lynn Dreifus, Tony Edelstein, Lauren Espinola, Hugh Ferguson, Eli Goldman, Emma Gubitz, Emma Hancock, Caroline Hanlon, Dewi Harjanto, Sebastian Hodge, Wilson Jacobs, JW, Divisha Khandelwal, Izzie Kirsch, Kenny Kirsch, Nicki Klar, Daniela Kotovsky, Ariel Kovlakas, Devika Kumar, Serena Lakhiani, Darren Lee, Tori Lee, Sophia Livecchi, Charlotte McCune, Mark McGovern, Nickon Mir, Jim Moore, Naqiya Motiwalla, Taher Motiwalla, Mae Nagusky, Stephen New, Isa Nicdao, Michelle Nip, Ray Orr, Zachary Paul, Grayson Pike, Addy Pedro, Noel Peng, Momo Ramstedt, Elliot Richardson, Noah Sai, Jada Shannon, Juniper Sokolov, Juliet Shen, Peter Steele, Janice Steele, Charmaine Thomas, Jean Paul Torre, Finn Trondson, Rebecca Urena, Adin Vashi, Edmund White, Val Yang, Josh You</div>
`;
