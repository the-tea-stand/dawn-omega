    ...
    perks: [
      {
        ...
        subtitle:
          "Partake in an educational, intimate tea ceremony led by tea practitioner Tim Chacko once a year. In-person & virtual.",
      },
      {
        state: "bold",
    ...
    perks: [
      {
        ...
        subtitle:
          "An artisanal 'easy gaiwan' teapot made by local ceramicist Lilian Wu.",
      },
      {
        state: "bold",
